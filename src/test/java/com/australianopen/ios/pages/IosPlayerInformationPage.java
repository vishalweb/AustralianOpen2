...
public class IosPlayerInformationPage {
	...
	private Logger log = LoggerHelper.getLogger(IosPlayerInformationPage.class);
	...
	public void clickOnFavoriteIcon(){
		...
		log.info("Waiting for the element:"+ IosPlayerInformationPageLocators.IOSPLAYER_INFO_FAVORITE_ICON);
	...
	public IosPlayersPage clickOnBackButton(){
		...
		log.info("Waiting for the element:"+ IosPlayerInformationPageLocators.IOSPLAYER_INFO_BACK_BTN);

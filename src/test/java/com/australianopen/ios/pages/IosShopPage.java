...
public class IosShopPage {
	...
	public void clickOnSesrchIcon(){
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_SEARCH);
	...
	public void clickOnRegister(){
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_REGISTER);
	...
	public void inputShopItemToSearch(String shoppingItem) throws Exception{
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_SEARCHTEXTFIELD);
	...
	public void inputFirstName(String firstName){
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_FIRSTNAME);
	...
	public void inputLastName(String lastName){
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_LASTNAME);
	...
	public void inputEmail(String email){
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_EMAIL);
	...
	public void inputPassword(String password){
		...
		testLog.log(LogStatus.INFO,"Waiting for the element:"+ IosShopPageLocators.IOSSHOP_PASSWORD);
